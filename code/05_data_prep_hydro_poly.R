##' Title: Data download and preparation national hydrography networks (POLYGONS)
...
st_write(water, paste0("/home/users/h/hierink/pop_grid/r/data/processed/vWater_poly/Water_poly_", file_name[i], ".shp"), append = F)
})
