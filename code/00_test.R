...
download_population(mainPath = mainPath, region = region, alwaysDownload = TRUE)
...
download_osm(x = "waterPolygons", mainPath = mainPath, region = region, countryName = FALSE, alwaysDownload = FALSE, mostRecent = NULL)
...
process_inputs(mainPath, region, mostRecent = FALSE, alwaysProcess = FALSE, defaultMethods = TRUE)
process_inputs(mainPath, region, mostRecent = TRUE, alwaysProcess = TRUE, defaultMethods = TRUE, changeRes = TRUE, newRes = 100, popCorrection = TRUE, gridRes = 2000)
